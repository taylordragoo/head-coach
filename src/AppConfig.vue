...
export default {
    ...
    methods: {
        ...
        changeMenuTheme(name, logoColor, componentTheme) {
            ...
            const appLogoUrl = `layout/images/logo-${logoColor === 'dark' ? 'dark' : 'white'}.svg`;
            const horizontalLogoLink = document.getElementById("logo-horizontal");
            const horizontalLogoUrl = `layout/images/logo-${logoColor === 'dark' ? 'dark' : 'white'}.svg`;
        ...
        changeLogo() {
            ...
            const horizontalLogoLink = document.getElementById("logo-horizontal");
            const logoUrl = `layout/images/logo-${this.d_colorScheme === 'light' ? 'dark' : 'white'}.svg`;

            if (appLogoLink) {
                appLogoLink.src = `layout/images/logo-${this.d_colorScheme === 'light' ? this.logoColor : 'white'}.svg`;
            }

            if (horizontalLogoLink) {
                horizontalLogoLink.src = `layout/images/logo-${this.d_colorScheme === 'light' ? this.logoColor : 'white'}.svg`;
            }

            ...
            <div class="col-12 xl:col-12">
                <div class="card">
                    ...
                    <DataTable v-if='selectedTeam != null' :value="selectedTeam.players" :paginator="true" :rows="20" responsiveLayout="scroll">
                        <Column field="first" header="First Name" :sortable="true"></Column>
                        <Column field="last" header="Last Name" :sortable="true"></Column>
                        <Column field="age" header="Age" :sortable="true"></Column>
                        <Column field="pos" header="Position" :sortable="true"></Column>
                        <Column field="exp" header="Experience" :sortable="true"></Column>
                    </DataTable>
                </div>
            </div>
        </div>

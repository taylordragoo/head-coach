...
"npm run test:unit": Runs the tests.
                ...
                <p>Diamond consists of 3 main parts; the application layout, layout resources and theme resources for PrimeVue components. <i>App.vue</i> inside app folder is the html
					template for the base layout, required resources for the layout are placed inside the <i>src/assets/sass/layout</i> folder and similarly theme resources are inside <i>src/assets/sass/theme</i> folder.</p>
...
import './App.scss'; 	                            //your styles and overrides
				...
				<p>Diamond provides 30 PrimeVue themes out of the box. Setup of a theme is simple by including the css of theme to your
					bundle that are located inside public/theme folder such as theme/teal/theme-light.css.</p>
				...
				<ul>
					...
					<li>Create a folder named "mytheme" under <i>public/theme</i> folder.</li>
					<li>Create a file such as theme.scss under <i>public/theme/mytheme</i> folder.</li>
...
sass --update public/theme/:public/theme/
				...
				<ul>
					...
					<li>Define the variables listed below and import the <i>/public/layout/_layout.scss</i> file.</li>
					<li>Build the scss to generate css</li>
...
@import '../../../src/assets/sass/layout/_layout';
				...
				<h5>src/assets/sass/variables/layout/_common.scss</h5>
...
$phoneBreakpoint:576px !default;
                ...
                <h5>src/assets/sass/variables/layout/_layout_light.scss</h5>
...
$rightSidebarBg: #ffffff !default;
                ...
                <h5>src/assets/sass/variables/theme/_theme_light.scss</h5>
